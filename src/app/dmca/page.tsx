...
export const metadata: Metadata = {
  title: 'DMCA Policy | SmartToolPicks',
  description: 'SmartToolPicks DMCA copyright infringement reporting policy and procedures.',
  ...
  return (
    <div className="pt-12 max-w-3xl mx-auto">
      ...
      <div className="prose max-w-none text-gray-600 leading-relaxed space-y-6">
        <p>{SITE_NAME} respects intellectual property rights. In accordance with the Digital Millennium Copyright Act of 1998, we respond promptly to valid claims of copyright infringement submitted to our designated DMCA agent.</p>

        <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Filing a DMCA Takedown Notice</h2>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Identification of the infringing material with sufficient information to locate it (URL is sufficient)</li>
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Where to Send DMCA Notices</h2>
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 my-4">
          <p className="text-gray-700 text-sm font-medium">DMCA Agent — SmartToolPicks</p>
          <p className="text-gray-500 text-sm mt-1">Email: <a href="mailto:dmca@smarttoolpicks.net" className="text-indigo-600 hover:underline">dmca@smarttoolpicks.net</a></p>
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Counter-Notification</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Repeat Infringers</h2>
        <p>It is our policy to terminate accounts of users who are repeat infringers in appropriate circumstances.</p>

        <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Disclaimer</h2>
        <p>The information on this page does not constitute legal advice. Consult a qualified attorney for questions about copyright law or the DMCA.</p>
      </div>
